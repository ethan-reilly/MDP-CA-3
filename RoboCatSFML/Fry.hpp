class Fry : public GameObject
{
public:

	CLASS_IDENTIFICATION('FRY', GameObject)

		enum EFryReplicationState
	{
		EYRS_Pose = 1 << 0,
		EYRS_Color = 1 << 1,
		EYRS_PlayerId = 1 << 2,
	...
	static	GameObject* StaticCreate() { return new Fry(); }
