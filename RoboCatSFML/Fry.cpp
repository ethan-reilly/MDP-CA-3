...
uint32_t Fry::Write(OutputMemoryBitStream& inOutputStream, uint32_t inDirtyState) const
{
...
bool Fry::HandleCollisionWithCat(RoboCat* inCat)
{
	(void)inCat;
...
void Fry::InitFromShooter(RoboCat* inShooter)
{
